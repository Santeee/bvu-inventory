...
<head>
    ...
    <title>Editar Item - Inventario</title>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('elementos') is-invalid @enderror" 
                                               id="elementos" name="elementos" value="{{ old('elementos', $item->elementos) }}" required>
                                        @error('elementos')
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('estado') is-invalid @enderror" id="estado" name="estado">
                                            ...
                                            <option value="Nuevo" {{ old('estado', $item->estado) == 'Nuevo' ? 'selected' : '' }}>Nuevo</option>
                                            <option value="Bueno" {{ old('estado', $item->estado) == 'Bueno' ? 'selected' : '' }}>Bueno</option>
                                            <option value="Roto" {{ old('estado', $item->estado) == 'Roto' ? 'selected' : '' }}>Roto</option>
                                        </select>
                                        @error('estado')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select class="form-select @error('uso') is-invalid @enderror" id="uso" name="uso">
                                            ...
                                            <option value="Sí" {{ old('uso', $item->uso) == 'Sí' ? 'selected' : '' }}>Sí</option>
                                            <option value="No" {{ old('uso', $item->uso) == 'No' ? 'selected' : '' }}>No</option>
                                        </select>
                                        @error('uso')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('ubicacion') is-invalid @enderror" 
                                               id="ubicacion" name="ubicacion" value="{{ old('ubicacion', $item->ubicacion) }}">
                                        @error('ubicacion')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('destino') is-invalid @enderror" 
                                               id="destino" name="destino" value="{{ old('destino', $item->destino) }}">
                                        @error('destino')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('observaciones') is-invalid @enderror" 
                                                  id="observaciones" name="observaciones" rows="3">{{ old('observaciones', $item->observaciones) }}</textarea>
                                        @error('observaciones')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control @error('observaciones_detalle') is-invalid @enderror" 
                                                  id="observaciones_detalle" name="observaciones_detalle" rows="3">{{ old('observaciones_detalle', $item->observaciones_detalle) }}</textarea>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('movimiento') is-invalid @enderror" 
                                               id="movimiento" name="movimiento" value="{{ old('movimiento', $item->movimiento) }}">
                                        @error('movimiento')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('fecha') is-invalid @enderror" 
                                               id="fecha" name="fecha" value="{{ old('fecha', $item->fecha ? $item->fecha->format('Y-m-d') : '') }}">
                                        @error('fecha')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('clasificacion_ruba') is-invalid @enderror" 
                                               id="clasificacion_ruba" name="clasificacion_ruba" value="{{ old('clasificacion_ruba', $item->clasificacion_ruba) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('carga_ruba') is-invalid @enderror" 
                                               id="carga_ruba" name="carga_ruba" value="{{ old('carga_ruba', $item->carga_ruba) }}">
                                        @error('carga_ruba')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('estado_general') is-invalid @enderror" 
                                               id="estado_general" name="estado_general" value="{{ old('estado_general', $item->estado_general) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('ubicacion_original') is-invalid @enderror" 
                                               id="ubicacion_original" name="ubicacion_original" value="{{ old('ubicacion_original', $item->ubicacion_original) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('destino_original') is-invalid @enderror" 
                                               id="destino_original" name="destino_original" value="{{ old('destino_original', $item->destino_original) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('nueva_ubicacion') is-invalid @enderror" 
                                               id="nueva_ubicacion" name="nueva_ubicacion" value="{{ old('nueva_ubicacion', $item->nueva_ubicacion) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('destino_final') is-invalid @enderror" 
                                               id="destino_final" name="destino_final" value="{{ old('destino_final', $item->destino_final) }}">
                                        @error('destino_final')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('operador') is-invalid @enderror" 
                                               id="operador" name="operador" value="{{ old('operador', $item->operador) }}">
                                        @error('operador')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control @error('operador_carga') is-invalid @enderror" 
                                               id="operador_carga" name="operador_carga" value="{{ old('operador_carga', $item->operador_carga) }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="date" class="form-control @error('fecha_actualizacion_inventario') is-invalid @enderror" 
                                               id="fecha_actualizacion_inventario" name="fecha_actualizacion_inventario" 
                                               value="{{ old('fecha_actualizacion_inventario', $item->fecha_actualizacion_inventario ? $item->fecha_actualizacion_inventario->format('Y-m-d') : '') }}">
